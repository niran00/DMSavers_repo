<?php
	...
	require_once( 'Rich_Web_Header.php' );
?>
<style type="text/css">
	.Rich_Web_Header_Main { position:relative; width: 99%; height: 140px; background: #6ecae9; margin-top: 30px; text-align: left; margin-bottom:20px; }
