...
<div class='Rich_Web_Header_Main'>
	...
	<div class="Rich_Web_Header_Free_Version">
		<!-- <div class="Rich_Web_Header_Free_Version_Shd">
			<a href="http://rich-web.org/wp-coming-soon" target="_blank" style="text-decoration: none; color: #fff; display: block;">
	...
	<div class="Rich_Web_Header_Contacts">
		...
		<a href="<?php echo home_url(); ?>?rw_cs_preview=true" target="_blank"  >Live Preview</a>
	</div>	
</div>