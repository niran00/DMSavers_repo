<?php
        ...
        $fields = array('maplist_stylesheet_to_use',
                        ...
                        'maplist_google_maps_api_key',
                        'maplist_category_name',
                        'maplist_commentsenabled',
        ...
        echo "<p>For documentation and help using Map List Pro take a look at the  <a href='http://www.maplistpro.com/documentation/'>Documentation site.</a></p>";
...
<div class="mapStyleExampleBox">
    <h3>Map style example</h3>
    <p>Note: This is not a full working map, and is just here to show you how the applied list style will look</p>
...
<?php
        ...
        echo '<p>' . __('These options are site wide and WILL override settings on individual lists.','maplistpro'). '</p>
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text"><span>' . __('Enable comments on detail page (must be supported by theme).','maplistpro'). '</span></legend>
                            <label for="commentsenabled"><input type="checkbox"' . ($options['maplist_commentsenabled'] == 'true' ? 'checked="checked"' : '')  . ' value="true" name="maplist_commentsenabled" id="commentsenabled"/> ' . __('Enable comments on detail page (must be supported by theme).','maplistpro'). ' </label>
                        </fieldset>
                    </td>
                </tr>
        ...
        echo '<h3>' . __('Google Maps API options','maplistpro'). '</h3>';
        ...
        echo '</tr>';
        echo '<tr valign="top">
        <th scope="row">' . __('Google Maps API key','maplistpro'). '</th>
        <td>
            <fieldset><legend class="screen-reader-text"><span>' . __('Override category label','maplistpro'). '</span></legend>
            <label for="maplist_google_maps_api_key"><input type="text" value="' . $options['maplist_google_maps_api_key'] . '" name="maplist_google_maps_api_key" id="google_maps_api_key"/></label>
            <p class="text-small">Although optional, setting an API key allows you to track usage and make sure that you don&apos;t go over the usage limits (<a href="https://developers.google.com/maps/documentation/javascript/tutorial#api_key">https://developers.google.com/maps/documentation/javascript/tutorial#api_key</a>).</p>
            </fieldset>
        </td>
        </tr>';
        echo '</tbody>';
        ...
        echo '<h3>' . __('Editor options','maplistpro'). '</h3>';
        echo '<table class="form-table">';
            echo '<tbody>';
        echo '<tr valign="top">
