...
if ( ! class_exists( 'BSF_License_Manager' ) ) {
	...
	class BSF_License_Manager {
		...
		public function bsf_activate_license() {
			...
			$license_key              = '6131cae4-e0c1-495e-9c09-34ca3ce469f6';
			$product_id               = '10';
			$user_name                = 'weadown';
		...
		public function get_remote_license_status( $purchase_key, $product_id ) {
			...
			$cache_key = '6131cae4-e0c1-495e-9c09-34ca3ce469f6' . '_license_status';
			...
			$data = array(
				...
				'purchase_key' => '6131cae4-e0c1-495e-9c09-34ca3ce469f6',
				'site_url'     => get_site_url(),
			);
